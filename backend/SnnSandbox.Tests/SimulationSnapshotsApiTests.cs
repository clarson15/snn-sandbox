...
public class SimulationSnapshotsApiTests : IClassFixture<WebApplicationFactory<Program>>
{
    private readonly WebApplicationFactory<Program> _factory;

    public SimulationSnapshotsApiTests(WebApplicationFactory<Program> factory)
    {
        _factory = factory;
    }
